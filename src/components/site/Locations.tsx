          ...
          {locations.map((loc) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between gap-2 rounded-lg bg-secondary/40 border border-glass-border px-3 py-2 group-hover:bg-secondary/60 transition-colors">
                  <code className="text-[11px] text-muted-foreground truncate min-w-0 flex-1">{loc.url}</code>
                  <span className="text-[11px] text-accent inline-flex items-center gap-1 shrink-0">
